...
export function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden nav-offset">
      ...
      <div className="relative z-10 max-w-7xl mx-auto container-spacing text-center py-16 md:py-24">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-full text-blue-400 text-sm md:text-base font-medium"
            >
            ...
            <motion.div
              ...
              className="flex items-center justify-center gap-2 text-gray-500 py-2"
            >
              <MapPin size={18} />
